  ...
  return (
    <div style={{ 
      ...
      <div style={{ padding: '0 4%' }}>
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem 0', marginBottom: '1.5rem', borderBottom: '1px solid #4a5568' }}>
        ...
        <main><Outlet /></main> {/* The new route should be defined in your main routing file (e.g., index.js or main.jsx) */}
      </div>
    </div>
  );
}
